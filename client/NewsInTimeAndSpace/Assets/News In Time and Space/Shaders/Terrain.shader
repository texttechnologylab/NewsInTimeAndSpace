Shader "Custom/Terrain"
{
	...
	SubShader
	{
		Pass
		{
			...
			#include "Assets/News In Time and Space/Scripts/Globe/Shader Common/GeoMath.hlsl"
			#include "Assets/News In Time and Space/Scripts/Globe/Shader Common/Triplanar.hlsl"
